import { Command, CommandMetadata, ExtractCommand, ExtractRawCommand, Renderer, Some, SubCommand } from '../core'
...
export type Button<Command extends SubCommand> = Renderer<
  'button',
  {
    text: Some<Text>
...
export type SubscribeButton = Renderer<
  'subscribeButton',
  {
    ...
    onUnsubscribeEndpoints: (SignalServiceEndpoint<
      'CLIENT_SIGNAL',
      OpenPopupAction<Renderer<'TODO'>>
    > &
      CommandMetadata)[]
